...
public partial class LignarisPizzaContext : IdentityDbContext<AppUser>
{
    ...
    public virtual DbSet<AtencionCliente> AtencionCliente { get; set; }
    public virtual DbSet<Compania> Compania { get; set; }
    public virtual DbSet<HoraNotificacion> HoraNotificacions { get; set; }
    public virtual DbSet<ChatServer> ChatServer { get; set; }
