...
{
    /// <inheritdoc />
    public partial class AddCloudMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TokenActivate = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "HoraNotificacions",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HoraCarrito = table.Column<TimeSpan>(type: "time", nullable: false),
                    ActivateCarrito = table.Column<bool>(type: "bit", nullable: false),
                    HoraSugerencias = table.Column<TimeSpan>(type: "time", nullable: false),
                    ActivateSugerencias = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HoraNotificacions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComoLlego = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdPersonalizedOffer = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    idRecetum = table.Column<int>(type: "int", nullable: false),
                    CantidadPizzas = table.Column<int>(type: "int", nullable: false),
                    CantidadDinero = table.Column<double>(type: "float", nullable: false),
                    InicioOferta = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FinOferta = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonalizedOffer", x => x.IdPersonalizedOffer);
                    table.ForeignKey(
                        name: "FK_PersonalizedOffer_receta_idRecetum",
                        column: x => x.idRecetum,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdAtencionCliente = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AtencionCliente", x => x.IdAtencionCliente);
                    table.ForeignKey(
                        name: "FK_AtencionCliente_cliente_IdCliente",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comentarios_cliente_IdCliente",
                        column: x => x.IdCliente,
                        principalTable: "cliente",
                        principalColumn: "id_cliente",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Comentarios_receta_IdReceta",
                        column: x => x.IdReceta,
                        principalTable: "receta",
                        principalColumn: "id_receta",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Compania_cliente_IdCliente",
                        column: x => x.IdCliente,
                        principalTable: "cliente",
                        principalColumn: "id_cliente",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatServer", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChatServer_cliente_IdCliente",
                        column: x => x.IdCliente,
                        principalTable: "cliente",
                        principalColumn: "id_cliente",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatServer_empleado_IdEmpleado",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AtencionCliente_IdCliente",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatServer_IdCliente",
                table: "ChatServer",
                column: "IdCliente");

            migrationBuilder.CreateIndex(
                name: "IX_ChatServer_IdEmpleado",
                table: "ChatServer",
                column: "IdEmpleado");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonalizedOffer_idRecetum",
                table: "PersonalizedOffer",
                column: "idRecetum");
