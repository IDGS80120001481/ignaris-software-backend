...
namespace LignarisBack.Migrations
{
    ...
    [Migration("20241201214036_AddCloudMigration")]
    partial class AddCloudMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LignarisBack.Models.AtencionCliente", b =>
                {
                    b.Property<int>("IdAtencionCliente")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdAtencionCliente"));
                    ...
                    b.HasKey("IdAtencionCliente");

                    b.HasIndex("IdCliente");

                    b.ToTable("AtencionCliente");
                });
            ...
            modelBuilder.Entity("LignarisBack.Models.ChatServer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LignarisBack.Models.Comentarios", b =>
                {
            ...
            modelBuilder.Entity("LignarisBack.Models.Compania", b =>
                {
                    b.Property<int>("IdCompania")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdCompania"));
            ...
            modelBuilder.Entity("LignarisBack.Models.HoraNotificacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("ActivateCarrito")
                        .HasColumnType("bit");

                    b.Property<bool>("ActivateSugerencias")
                        .HasColumnType("bit");

                    b.Property<TimeSpan>("HoraCarrito")
                        .HasColumnType("time");

                    b.Property<TimeSpan>("HoraSugerencias")
                        .HasColumnType("time");

                    b.HasKey("Id");

                    b.ToTable("HoraNotificacions");
                });
            ...
            modelBuilder.Entity("LignarisBack.Models.PersonalizedOffer", b =>
                {
                    b.Property<int>("IdPersonalizedOffer")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdPersonalizedOffer"));

                    b.Property<double>("CantidadDinero")
                        .HasColumnType("float");

                    b.Property<int>("CantidadPizzas")
                        .HasColumnType("int");

                    b.Property<DateTime>("FinOferta")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("InicioOferta")
                        .HasColumnType("datetime2");

                    b.Property<int>("idRecetum")
                        .HasColumnType("int");

                    b.HasKey("IdPersonalizedOffer");

                    b.HasIndex("idRecetum");

                    b.ToTable("PersonalizedOffer");
                });
            ...
            modelBuilder.Entity("LignarisBack.Models.ChatServer", b =>
                {
                    ...
                    b.HasOne("LignarisBack.Models.Empleado", "Empleado")
                        .WithMany("ChatServer")
            ...
            modelBuilder.Entity("LignarisBack.Models.Comentarios", b =>
                {
                    ...
                    b.HasOne("LignarisBack.Models.Recetum", "Recetas")
                        .WithMany("Comentarios")
            ...
            modelBuilder.Entity("LignarisBack.Models.Compania", b =>
                {
                    b.HasOne("LignarisBack.Models.Cliente", "Cliente")
                        .WithOne("Compania")
                        .HasForeignKey("LignarisBack.Models.Compania", "IdCliente")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LignarisBack.Models.PersonalizedOffer", b =>
                {
                    b.HasOne("LignarisBack.Models.Recetum", "Recetum")
                        .WithMany("PersonalizedOffers")
                        .HasForeignKey("idRecetum")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LignarisBack.Models.Recetum", b =>
                {
                    ...
                    b.Navigation("PersonalizedOffers");
